    ...
    <main class="nk-pages">
                    ...
                    <div class="row align-items-center gutter-vr-30px pdb-l">
                        <div class="col-lg-6">
                            <div class="nk-block-text">
                                <h2 class="title animated" data-animate="fadeInUp" data-delay=".1">درباره فناور ستاره نوران</h2>
                            ...
                            <div class="col-lg-6">
                                <div class="animated" data-animate="fadeInUp" data-delay=".4">
                                    <div class="token-status bg-theme">
                                        <h4 class="title title-md">سیستم باشگاه مشتریان</h4>
                                        <div class="token-countdown countdown" data-date="2019/08/03"></div>
                                        <div class="progress-wrap progress-wrap-point">
                                            <span class="progress-info">افزایش بیشتر از <span>۱۰۰۰۰۰ تومان</span></span>
                                            <div class="progress-bar">
                                                <div class="progress-percent bg-grad" data-percent="30"></div>
                                                <div class="progress-point progress-point-1">شروع <span>۱۰۰۰ تومان</span></div>
                                                <div class="progress-point progress-point-2">پایان <span>۱۰۰۰ تومان</span></div>
                                            </div>
                                        </div>
                                        <a href="#" class="btn btn-grad">عضویت در سیستم باشگاه مشتریان</a>
                                        <span class="token-min">حداقل خرید: ۵۰ هزار تومان</span>
                                    </div>
                                    <div class="bonus bg-theme">
                                        <div class="bonus-info">
                                            <div class="bonus-percent">۵۰٪ <small>جایزه</small></div>
                                            <div class="bonus-date">یک ماه</div>
                                            <span class="bonus-badge badge-xs">الان</span>
                                        </div>
                                        <div class="bonus-info">
                                            <div class="bonus-percent">۲۵٪<small>جایزه</small></div>
                                            <div class="bonus-date">یک هفته</div>
                                        </div>
                                    </div>
                                </div>
                            </div><!-- .col -->
        ...
        <section class="section bg-light section-l section-document" id="documents">
            ...
            <div class="container">
                <!-- Section Head @s -->
                <div class="section-head text-center wide-auto">
                    <h2 class="title animated" data-animate="fadeInUp" data-delay=".1">مستندات و بانک سورس</h2>
                    <p class="animated" data-animate="fadeInUp" data-delay=".2">مستندات و بانک سورس</p>
                </div><!-- .section-head @e -->
                <!-- Block @s -->
        ...
        <!-- // -->
        <section class="section section-l section-wallet-bottom bg-white pdt-0" id="wallet">
                        ...
                        <div class="col-xl-10">
                            <div class="roadmap-wrap">
                                ...
                                <div class="roadmap animated" data-animate="fadeInUp" data-delay=".4">
                                    <div class="roadmap-year byekan">مرحله ۱</div>
                                </div>
                                <div class="roadmap roadmap-left roadmap-finished animated" data-animate="fadeInUp" data-delay=".5">
                                    <div style="margin-top:80px" class="roadmap-step">
                                ...
                                <div class="roadmap animated " data-animate="fadeInUp" data-delay=".4">
                                    <div class="roadmap-year byekan">مرحله ۲</div>
                                </div>
                                ...
                                <div class="roadmap animated " data-animate="fadeInUp" data-delay=".4">
                                    <div class="roadmap-year byekan">مرحله ۳</div>
                                </div>
                                <div class="roadmap roadmap-left roadmap-finished animated" data-animate="fadeInUp" data-delay=".5">
                                    <div style="margin-top:80px" class="roadmap-step">
                                        <div class="roadmap-head">
                    ...
                    <div class="row">
                        <div class="col-md-4 col-lg-3 mb-4 mb-lg-0">
                            <ul class="nav tab-nav tab-nav-vr tab-nav-bdr mr-lg-3 animated" data-animate="fadeInUp" data-delay=".3">
                                ...
                                <li><a data-toggle="tab" href="#ico-questions"><em class="fas fa-caret-right"></em>پرداخت یاری</a></li>
                                <li><a data-toggle="tab" href="#tokens-sales"><em class="fas fa-caret-right"></em>فروشگاه ساز</a></li>
                                <li><a data-toggle="tab" href="#clients-releted"><em class="fas fa-caret-right"></em>سیستم فروش شارژ</a></li>
                            </ul>
                        </div><!-- .col -->
                                ...
                                <div class="tab-pane fade show active" id="general-questions">
                                    <div class="accordion accordion-faq" id="faq-1">
                                        <div class="accordion-item animated" data-animate="fadeInUp" data-delay=".1">
                                            <h5 class="accordion-title accordion-title-sm" data-toggle="collapse" data-target="#faq-1-1">متن سوال <span class="accordion-icon"></span></h5>
                                        ...
                                        <div class="accordion-item animated" data-animate="fadeInUp" data-delay=".2">
                                            <h5 class="accordion-title accordion-title-sm collapsed" data-toggle="collapse" data-target="#faq-1-2">متن سوال <span class="accordion-icon"></span></h5>
                                        ...
                                        <div class="accordion-item animated" data-animate="fadeInUp" data-delay=".3">
                                            <h5 class="accordion-title accordion-title-sm collapsed" data-toggle="collapse" data-target="#faq-1-3"> متن سوال <span class="accordion-icon"></span></h5>
                                        ...
                                        <div class="accordion-item animated" data-animate="fadeInUp" data-delay=".4">
                                            <h5 class="accordion-title accordion-title-sm collapsed" data-toggle="collapse" data-target="#faq-1-4">متن سوال <span class="accordion-icon"></span></h5>
