    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                ...
                <main>
                    <div class="row mt-5">
                        <div class="search-box">
                            ...
                            <form action="{{ route('shops-products.index') }}" class="search-form" method="get" id="srch">
                ...
                @if(count(request()->all()) != 0 && count($products) != 0 )
                                              ...
                                              aria-describedby="datatable_info">
                                                ...
                                                <tbody class="byekan">
                                                    ...
                                                    <tr role="row" class="odd">
                                                        <td class="sorting_1 w-25 "><img src="{{ $product->image['80,80'] }}" class="rounded" alt="" height="52" width="52">
