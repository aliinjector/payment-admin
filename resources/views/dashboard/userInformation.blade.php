...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-lg-6">
            <div class="card card-eco">
                <div class="card-body">
                    <h4 class="title-text mt-0"> احراز هویت شده</h4>
                    <div class="d-flex justify-content-between">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table id="datatable" class="table table-bordered dt-responsive nowrap dataTable no-footer font-16" style="text-align: center" role="grid">
                            <thead>
                            <tr>
                                <th>شناسه</th>
                                <th>نام</th>
